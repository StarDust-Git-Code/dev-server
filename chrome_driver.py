...
def get_chrome_major_version():
    ...
    # 2. Try running the Chrome executable with --version
    ...
    if chrome_path:
        try:
            ...
            print(f"[ChromeDriver] Failed to run Chrome for version check: {e}")
...
def create_driver():
    ...
    if version_main:
        print(f"[ChromeDriver] Detected Chrome major version: {version_main}")
    else:
        print("[ChromeDriver] Could not detect Chrome version. Defaulting to auto-detection.")
